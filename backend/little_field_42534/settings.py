"""
Django settings for little_field_42534 project.
...
ROOT_URLCONF = 'little_field_42534.urls'
...
WSGI_APPLICATION = 'little_field_42534.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "little_field_42534 API",
    "DESCRIPTION": "API documentation for little_field_42534 App",
    "VERSION": "v1",
}
